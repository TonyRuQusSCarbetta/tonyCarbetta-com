...
function getHoro(userInput){
    ...
    document.getElementById('mainHeader').innerHTML = 'Thanks for checking!<br>Your Horoscope is ';
    document.getElementById('hideImage').src = "";
    document.getElementById('title').innerHTML = userHoro.title;
    document.getElementById('title').className = 'mt-2 mx-auto bg-dark text-light animated rollIn';
    document.getElementById('img').innerHTML = userHoro.img;
    document.getElementById('img').className = 'mt-2 mb-2 img-fluid maxHeightImage animated rotateIn';
    document.getElementById('info').innerHTML = userHoro.info;
    document.getElementById('info').className = 'mt-2 mb-4 pl-1 pr-1 text-light bg-primary rounded mx-auto';
    document.getElementById('img').src = userHoro.img;
    document.getElementById('zodiacSigns').src = 'img/Zodiac-Signs.jpg';
    document.getElementById('zodiacSigns').className = ' hvr-grow mb-5 img-fluid mx-auto d-block maxHeightImage animated rotateIn';
}
...
var horos = {
  aries:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/01f605f4-df0b-47e2-a145-4bb8c0aa8422.jpg'
  },
  taurus:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/de286e40-5db0-4ec4-8a7e-f80457d9c5c6.jpg'
  },
  ...
  gemini:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/babd7de1-89d0-4606-84f7-e47865bce3aa.jpg'
  },
  ...
  cancer:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/1f6f4721-5788-4cfc-937e-d092bb4e1772.jpg'
  },
  ...
  leo:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/fdcce561-f792-4453-9d8a-1bff8b39659e.jpg'
  },
  virgo:{
  ...
  libra:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/960c7cec-74e8-4cfc-9698-acafa7781b45.jpg'
  },
  ...
  scorpio:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/8207d5cd-5200-4ebd-a895-352b9ef42a1d.jpg'
  },
  ...
  sagittarius:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/1e0b92f2-972b-4d76-bc1f-3cedd5731045.jpg'
  },
  ...
  capricorn:{
    ...
    img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/f0c2c243-3715-4982-88ac-d1dd90a3e12d.jpg'
  },
    ...
    aquarius:{
      ...
      img: 'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/c59bb177-716e-409f-85a4-4b13461fa80b.jpg'
    },
    ...
    pisces:{
        ...
        img:  'http://cdn.playbuzz.com/cdn/82706aea-1849-4a50-85f2-3fc1127cb660/a80e35fa-1348-450f-8e92-ad193cd4a473.jpg'
    },
    default: {
        title: 'Whoops! ',
        info: 'You entered an invalid Zodiac sign.',
        img: 'http://www.callscotland.org.uk/common-assets/images/theme/try-again.png'
    }
};
